      ...
      {({ signOut, user }) => (
        <main className="relative">
          ...
          <div className="absolute top-4 right-4 z-10">
            <span className="text-sm font-medium text-gray-700">{user?.signInDetails?.loginId}</span>
            <button onClick={signOut} className="mb-4 px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600 transition-colors">Sign out</button>
          </div>
